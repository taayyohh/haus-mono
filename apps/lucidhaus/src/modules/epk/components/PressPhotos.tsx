    ...
    <>
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-colors flex items-center justify-center">
              <div className="opacity-0 group-hover:opacity-100 transition-opacity flex flex-col gap-2">
                <button
                  ...
                  className="bg-white text-black px-6 py-2 uppercase text-sm font-medium hover:bg-gray-200"
                >
                  View
                </button>
                <button
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Content */}
          <div className="relative z-10 bg-[#131313] border border-white-13 rounded p-6 max-w-[90vw] max-h-[90vh] overflow-auto">
            {/* Close button */}
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 text-white bg-[#131313] hover:bg-[#111] rounded-full flex items-center justify-center border border-white-13 text-sm h-10 w-10 z-20"
            >
              ✕
            </button>
